...
def interval_clustering(t_windows,periodic_tasks):
    ...
    windows = [x.copy() for x in t_windows]
...
if __name__ == "__main__":
    ...
    chain, rem_time, rem_time_seq, gamma, portions, portions0 = task_scheduler(rois,t_windows,subformula_types,xold,u_agent_max,v_tar_max)

    print('Chain:',chain)
    print('Remaining time:',rem_time)
    print('Remaining time seq:',rem_time_seq)

    print('Gamma:',gamma)
    print('Portions:',portions)
    print('Portions0:',portions0)
