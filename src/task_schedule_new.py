...
if __name__ == "__main__":
    # Example usage
    scenario = 1 # 0: no periodic tasks, 1: periodic tasks, 2: periodic tasks with alternatives
    if scenario == 0:
        ...
        chain, rem_time, rem_time_seq, gamma, portions, portions0 = task_scheduler(rois,t_windows,subformula_types,x0,umax,v_tar_max)
